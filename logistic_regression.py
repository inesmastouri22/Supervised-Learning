...
# Label encode categorical columns, assuming 'Gender' is a categorical column
label_encoder = LabelEncoder()
social_network_ads['Gender'] = label_encoder.fit_transform(social_network_ads['Gender'])

# Plot the heatmap for correlation of all columns
sns.heatmap(social_network_ads.corr(), annot=True, cmap='coolwarm')
plt.show()
